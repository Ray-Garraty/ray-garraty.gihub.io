...
const websitesList = [
  ...
  src.generateNewsArrayFromRSS('https://www.popmech.ru/out/public-all.xml', 'беспилотник', 'дрон', 'БЛА', 'БПЛА', 'беспилотн', 'автономн'),
  src.generateNewsArrayFromRSS('https://hightech.plus/feed.rss', 'беспилотник', 'дрон', 'БЛА', 'БПЛА', 'беспилотн', 'автономн'),
  src.generateNewsArrayFromRSS('https://nplus1.ru/rss', 'беспилотник', 'дрон', 'БЛА', 'БПЛА', 'беспилотн', 'автономн'),
